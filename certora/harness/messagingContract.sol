...
import "../munged/l1/interfaces/IStarknetMessaging.sol";
...
contract StarknetMessaging is IStarknetMessaging {
    ...
    */
    ...
    function messageCancellationDelay(uint256 delayInSeconds) internal {
        NamedStorage.setUintValue(
            L1L2_MESSAGE_CANCELLATION_DELAY_TAG,
            delayInSeconds
        );
    }
    ...
    */
    function l1ToL2MessageCancellations(bytes32 msgHash)
        external
        view
        returns (uint256)
    {
    ...
    {
        return
            NamedStorage.bytes32ToUint256Mapping(
                L1L2_MESSAGE_CANCELLATION_MAP_TAG
            );
    }
